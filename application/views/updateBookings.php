                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form method="post">
                            <div class="row">
                                <div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" name="first_name" value="<?php echo $row->first_name; ?>" type="text">
									</div>
                                </div>
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Last Name </label>
                                        <input class="form-control" name="last_name" value="<?php echo $row->last_name; ?>" type="text">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Email Address</label>
                                        <input class="form-control" name="email" value="<?php echo $row->email; ?>" type="text">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="m-t-20 text-center">
                               <input type="submit" class="btn btn-primary submit-btn" name="updatebookings" value="Update Bookings"></input>
                            </div>
                        </form>
                        <?php } ?>
                    </div>
